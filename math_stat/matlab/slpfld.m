% slpfld(funct,B,p,density,init_conds,options)
%
...
%       be used.
% B = [a b c d] are the limits of the region [a,b] x [c,d] of the
...
function slpfld(funct,B,p,density,init_conds,options)
